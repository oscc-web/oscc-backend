...
// Module imports
import fs from 'fs'
import createLogger, { dummyLogger } from '../utils/logger.js'
// Import custom extensions
import './extendHttp.js'
/**
 ...
 */
export function init(meta, logOutputLevel = config?.logLevel || 'access') {
	setIdentity(meta)
	logger = createLogger(identity, IS_DEVELOPMENT_MODE, logOutputLevel)
}
...
export const IS_DEVELOPMENT_MODE = Rx.devMode.test(config.mode)
